        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              effectively. Be it word count, chracter count, remove extra spaces
              and many more.
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              Chrome, Firefox, Safari, etc. It suits to count characters in
              Facebook, Blog, Excel Document, PDF Document, Essays, etc.
            </div>
          </div>
        </div>
      </div>
